...
*& Version: 1.0 - Generated by Antigravity AI
*&---------------------------------------------------------------------*
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_carrier_summary,
        ...
        fleet_capacity  TYPE p LENGTH 5 DECIMALS 2, " % Occupied
...
CLASS zcl_hello_btp_test IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    TRY.
        ...
        out->write( |      [Antigravity AI] Live Airline Comparison & Capacity Utilization                   | ).
        ...
        " 2. Aggregate metrics per Airline using ABAP 7.50+ REDUCE & Table Loops
        ...
        LOOP AT lt_unique_carriers INTO DATA(ls_unique).
          ...
          DATA(lv_occupancy) = COND decfloat34(
            WHEN lv_seats_max > 0
            THEN ( CONV decfloat34( lv_seats_occ ) / lv_seats_max ) * 100
            ELSE 0 ).
        ...
        out->write( 'Live Airline Carrier Performance Summary (/DMO/CARRIER + /DMO/FLIGHT):' ).
